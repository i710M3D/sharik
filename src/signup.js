...
<div className=" ml-[6%] mr-[6%] flex flex-wrap w-[473px]">
  ...
  <div className="flex flex-row items-center text-center border-box w-[363px] h-[68px] bg-white border-[1px] border-solid border-[#333333]/30 rounded-[18px] mt-[52px] smn:mx-auto  mdn:mx-0 lg:mx-0">
    ...
    <Link to='/' className=' smn:mx-auto mdn:mx-0 lg:mx-0' >
    <div className=" cursor-pointer mt-[40px] flex items-center justify-center w-[250px] h-[64px] bg-[#111111] opacity-25 rounded-[32px] text-white font-mon font-medium text-[22px] leading-[27px] mb-[10px]  ">
        <p >Sign up</p>
    </div>
    </Link>
    <Link to='/signin' className=' smn:mx-auto mdn:mx-0 lg:mx-0'>
    <span className="  cursor-pointer font-mon font-normal text-[16px] leading-[20px] text-[#333333]  ">Already have an ccount? <span className='underline font-medium'>Log in </span></span>
    </Link>
